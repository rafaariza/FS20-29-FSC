...
En el marco FLRW, el campo escalar es homogéneo y por tanto, solo depende del tiempo, i.e., \(\phi\left(t,\symbf{x}\right)\rightarrow\phi(t)\). Este obedece la ecuación de movimiento
\begin{equation}
    \ddot{\phi}+3H\dot{\phi}+V'(\phi)=0,
\end{equation}
donde \(V'(\phi)=\mathrm{d}V/\mathrm{d}\phi\)

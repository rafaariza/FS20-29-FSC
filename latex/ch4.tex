...
\begin{figure}[h!]
    \centering
    {\input{../scripts64/img/pdek-(0)-DEF-0.pgf}}
...
Con este resultado se puede afirmar que la función de transferencia no tiene gran efecto en las fluctuaciones a grandes escalas (pequeños \(k\)).
\begin{figure}
    \centering
    \def\svgwidth{.94\textwidth}
